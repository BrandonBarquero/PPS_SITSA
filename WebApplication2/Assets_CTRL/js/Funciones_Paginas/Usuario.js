...
function Validar_Campo() {
    ...
    if (document.getElementById("cedula").value.trim() == "" || document.getElementById("nombre").value.trim() == "" || document.getElementById("email").value.trim() == "" || document.getElementById("perfil").value.trim() == "") {
